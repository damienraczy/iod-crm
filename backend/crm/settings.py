...
# Cloud (OLLAMA_CLOUD_URL + OLLAMA_API_KEY) . PAS DE LOCAL
# ---------------------------------------------------------------------------
...
# Configuration explicite des méthodes d'authentification
AUTHENTICATION_BACKENDS = [
    "django.contrib.auth.backends.ModelBackend",  # Autorise login/password
]
